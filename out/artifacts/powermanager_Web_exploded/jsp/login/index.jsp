...
<html>
	...
	<body>
		<div class='login'>
			...
			<div class='login_fields'>
				<div class='login_fields__user'>
					...
					<input name="username" id="username" placeholder='手机号码' maxlength="16" type='text' autocomplete="off" value="15195192255" />
				...
				<div class='login_fields__password'>
					...
					<input name="password" id="password" placeholder='密码' maxlength="16" type='password'value="000000" autocomplete="off">
					<div class='validation'>
						<img alt="" src='<%=basePath%>static/login/img/tick.png'>
					</div>
				</div>
				<div class='login_fields__password'>
					...
					<img id="codeimg" src="<%=basePath%>util/code" onclick="changeimg(this)">
				</div>
		...
		<script type="text/javascript">
			...
			function changeimg(img){//点击验证码更新
					...
					if(username == '') {
						...
						$.ajax({
							...
							success:function (data) {
								if(data.code=='10000')
								{
									window.location.replace("<%=basePath%>index")//登录成功返回
									//点击登录后无论是否登录成功都更新验证码
